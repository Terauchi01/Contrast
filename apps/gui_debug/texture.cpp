bool tiles_texture_available() { return tex_id != 0; }
// Minimal, safe stub implementation.
// Currently this checks whether an assets file exists and logs it. Actual image loading
// (stb_image + OpenGL texture creation) can be enabled later when the asset is committed.
